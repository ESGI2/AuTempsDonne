    ...
    return (
        <>
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Footer>
                    <button onClick={() => setShowNewActivityModal(true)} className="btn btn-primary">Nouvelle activité</button>
            ...
            <Modal show={showNewActivityModal} onHide={() => setShowNewActivityModal(false)}>
                ...
                <Modal.Footer>
                    ...
                    <button onClick={() => setShowNewActivityModal(false)} className="btn btn-secondary">Annuler</button>
                </Modal.Footer>
            </Modal>
        </>
    );
