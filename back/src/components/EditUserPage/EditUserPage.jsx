...
const EditUserPage = ({ match }) => {
    // Ici, vous pouvez utiliser match.params.id pour obtenir l'ID de l'utilisateur à éditer


    // Implémentez la logique de modification des informations de l'utilisateur ici
